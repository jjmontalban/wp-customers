...
{ 
    ...
    {
        $actions = array(
            'view' => sprintf('<a href="?page=customer&id_customer=%s">%s</a>', $item['id_customer'], __('View', 'gbc')),
...
/* function gbc_customer_meta_box($customer)
{
    ?>
